      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Edunexs LearnSphere</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              A global hub for learning. Empowering students and educators worldwide with 
              cutting-edge online education technology and comprehensive learning resources.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/practice" className="text-gray-300 hover:text-primary-500 transition-colors">
                  Start Practice
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">edunexlearnsphere@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-primary-500" />
                <span className="text-gray-300">+2348128653553</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Edunexs LearnSphere. All rights reserved.
          </p>
